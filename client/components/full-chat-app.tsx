...
const CLAUDE_MODELS = [
  // Active model
  { id: "meta-llama/Llama-3.1-8B-Instruct", name: "LLaMA 3.1 8B", description: "Self-hosted open model (vLLM)" },
  // LLaMA models (coming soon)
  { id: "meta-llama/Llama-4-Scout-17B", name: "LLaMA 4 Scout", description: "17B params, 16 experts (MoE)", badge: "Coming Soon", disabled: true },
  { id: "meta-llama/Llama-4-Maverick-17B", name: "LLaMA 4 Maverick", description: "17B params, 128 experts (MoE)", badge: "Coming Soon", disabled: true },
  { id: "meta-llama/Llama-3.3-70B-Instruct", name: "LLaMA 3.3 70B", description: "Multilingual, high performance", badge: "Coming Soon", disabled: true },
  { id: "meta-llama/Llama-3.2-3B-Instruct", name: "LLaMA 3.2 3B", description: "Lightweight edge model", badge: "Coming Soon", disabled: true },
  { id: "meta-llama/Llama-3.1-70B-Instruct", name: "LLaMA 3.1 70B", description: "128K context, multilingual", badge: "Coming Soon", disabled: true },
  { id: "meta-llama/Llama-3.1-405B-Instruct", name: "LLaMA 3.1 405B", description: "Frontier-level open model", badge: "Coming Soon", disabled: true },
  // GPT-OSS models (coming soon)
  { id: "openai/gpt-oss-120b", name: "GPT-OSS 120B", description: "117B params, MoE, single GPU", badge: "Coming Soon", disabled: true },
  { id: "openai/gpt-oss-20b", name: "GPT-OSS 20B", description: "21B params, runs on 16GB VRAM", badge: "Coming Soon", disabled: true },
] as const
...
function ChatContent({
  ...
  const requestBody = useMemo(() => ({
    ...
    conversationId,
    activeMcpIds,
  }), [selectedModel, conversationId, activeMcpIds])
  ...
  return (
    <PanelGroup orientation="horizontal" className={cn("h-full", panelResizeTransition && "panel-resize-transition")}>
      ...
      <Panel defaultSize={artifactPanelMounted ? 50 : 100} minSize={30} className="!overflow-hidden">
                      ...
                      <div className="w-full max-w-2xl flex flex-col items-center text-center">
                        ...
                        >
                          <ClaudeChatInput
                            ...
                            models={CLAUDE_MODELS as unknown as { id: string; name: string; description: string; badge?: string; disabled?: boolean }[]}
                ...
                >
                  <div className="mx-auto max-w-3xl">
                    ...
                    <p className="mt-2 text-center text-[10px] text-muted-foreground/50">
                      State of California, Department of Motor Vehicles. All Rights Reserved. Version 1.0
                    </p>
                  </div>
                </motion.div>
              )}
