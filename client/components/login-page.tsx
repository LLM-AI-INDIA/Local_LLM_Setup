            ...
            <div className="hidden w-[55%] flex-col justify-between border-r border-border bg-muted/40 lg:flex">
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-14">
                    ...
                    <div className="max-w-lg">
                        <h2 className="text-[2.25rem] font-semibold leading-[1.2] text-foreground">
                            Instant Insights. Local LLM.
                            <br />
                    ...
                    <div className="mt-10 flex items-center gap-4">
                        <div className="flex items-center gap-3 rounded-full bg-background/80 px-5 py-2.5 ring-1 ring-border hover:scale-[1.02] transition-transform">
                ...
                <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-16">
                    ...
                    <div className="w-full max-w-[400px]">
                        ...
                        <p className="mt-8 text-center text-[11px] text-muted-foreground/50">
                            &copy; 2026 State of California, Department of Motor Vehicles. All Rights Reserved.
                            <br />
                            Official Government Website. Version 1.0
                        </p>
                    </div>
                </div>
            </div>
